class FlatsController < ApplicationController
  ...
  private
    ...
    def flat_params
      params.require(:flat).permit(:title, :description, :location, :latitude, :longitude, :price_per_night, :check_in, :check_out, :guests, :bedrooms, :bathrooms, :wifi, :aircon, :rating, :user_id)
    end
end
